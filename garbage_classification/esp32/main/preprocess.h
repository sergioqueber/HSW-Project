 ...
 * 
 *This function takes the camera frame buffer containing RGB565 pixel data
 * and converts it into a 3-channel RGB int8 tensor for the quantized model.
 * The pixel values are normalized and quantized. 
